...
@Entity
@Table(name = "criterios", catalog = "ventura_hr", schema = "")
@NamedQueries({
...
public class Criterio implements Serializable {
    ...
    private int peso;
    @JsonIgnore
    @JoinColumn(name = "id_vaga2", referencedColumnName = "id", nullable = false)
    @ManyToOne(optional = false)
    private Vaga idVaga2;
    ...
    public Vaga getIdVaga2() {
        return idVaga2;
    }

    public void setIdVaga2(Vaga idVaga2) {
